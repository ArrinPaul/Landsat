...
interface CropAdvisorTabContentProps {
    lat: string;
    lon: string;
    locationDesc: string;
}

export function CropAdvisorTabContent({ lat, lon, locationDesc }: CropAdvisorTabContentProps) {
    ...
    // Clear results if location changes significantly (optional, but good for UX)
    useEffect(() => {
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>{t('cropAdvisor.description')} ({locationDesc})</CardDescription>
                </CardHeader>
                <CardContent>
