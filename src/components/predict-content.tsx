...
import { Thermometer, Tractor, Droplets, LandPlot, BarChartBig, AlertTriangle, BrainCircuit, Loader2 } from "lucide-react";
...
export function PredictTabContent({ lat, lon }: PredictTabContentProps) {
